...
public class AdminGraph extends JFrame {
	...
	public String columnName[] = { "�긽�샇紐�", "�뾽二쇰�?", "�궗�뾽�옄�벑濡앸쾲�?��", "�벑濡�" };
	public Object row [][]={{"�븳�떊�룷李�","�젙誘쇱�?","90c8815","�벑濡�"},{"�궪嫄곕?���룷李�","諛깆쥌�?��","90e8815","�벑濡�"}};
...
//					frame.setResizable(false);
	...
	public AdminGraph() {
		...
		tabbedPane.addTab("�?리자 ?���?", null, adminStasticsPn, null);
		...
		tabbedPane.addTab("�?리자?��?���?�?", null, adminManagerPn, null);
