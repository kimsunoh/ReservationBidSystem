...
public class AdminGraph extends JFrame{
	...
	public String columnName[] = {"?ÉÅ?ò∏Î™?","?óÖÏ£ºÎ™Ö","?Ç¨?óÖ?ûê?ì±Î°ùÎ≤à?ò∏","?ì±Î°?"};
...
//					frame.setResizable(false);
	...
	public AdminGraph() {
		...
		tabbedPane.addTab("Í¥?Î¶¨Ïûê ?ÜµÍ≥?", null, adminStasticsPn, null);
		...
		tabbedPane.addTab("Í¥?Î¶¨Ïûê?öå?õêÍ¥?Î¶?", null, adminManagerPn, null);
